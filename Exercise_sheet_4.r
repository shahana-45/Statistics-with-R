...
cohensD(mean ~ NativeLanguage, data = bySubjNatLang)


## 22.  Which effect size do we get? How do you interpret this result?

# We get an effect size of 1.13 which means that the 2 groups differ by 1.13 standard deviations.


## 23. Choose an appropriate plot to visualize the difference between group
boxplot(mean~NativeLanguage, data=bySubjNatLang)
...
tutor <- c("tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2")



names(tutor)
## 5. Create a data frame named "data_frame" having 2 columns "tutor", "score" created above.
data_frame <- data.frame(score, factor(tutor))
str(data_frame)
...
#independentSamplesTTest(factor.tutor. ~ factor.score., data_frame, var.equal=TRUE)
independentSamplesTTest(score~factor.tutor., data_frame)

# The effect size indicates how many standard deviations the two groups differ by for eg. effect size of 1
# indicates that the 2 groups differ by 1 std. deviation.
...
#  try 1
tutor1_grades <- rnorm(n = 14, mean = 10, sd = 5)

tutor2_grades <- rnorm(n = 14, mean = 25, sd = 10)

score <- c(tutor1_grades, tutor2_grades)

tutor <- c("tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2")
...
#  try 2
tutor1_grades <- rnorm(n = 13, mean = 5, sd = 2)
tutor2_grades <- rnorm(n = 13, mean = 10, sd = 4)

score <- c(tutor1_grades, tutor2_grades)

tutor <- c("tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2")
...
#  try 3
tutor1_grades <- rnorm(n = 12, mean = 50, sd = 6)
tutor2_grades <- rnorm(n = 12, mean = 50, sd = 6)

score <- c(tutor1_grades, tutor2_grades)

tutor <- c("tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor1", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2", "tutor2")
...
#The samples are independent because they don't overlap; none of the observations belongs to both samples simultaneously. A textbook example is male versus female respondents.
# When we keep mean and sd the same, we observe that the p-value is high, hence the null hypothesis can be rejected and Cohen's d is low.
